...
public class RegisteredClassSpec<T> extends RegisteredSpec {

  @SuppressWarnings("unchecked")
  public RegisteredClassSpec(String doWhat, ClassSpecBody body, T instance) {
    super(doWhat, () -> body.execute(instance));
  }
}
